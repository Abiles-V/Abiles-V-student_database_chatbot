...
# Function to generate SQL queries using Gemini API
def get_gemini_response(question, department):
...
if question and submit_button:
    if authenticate(username, password, department):
        ...
        sql_query = get_gemini_response(question, department)
        
        # Execute SQL query and retrieve data
        data = read_sql_query(sql_query, "student1.db")
